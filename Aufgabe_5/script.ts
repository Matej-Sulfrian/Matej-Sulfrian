...
console.log("Relativ zur Gesamtemission der Welt verursacht Asien damit " + Asia2018 * 100 / totalEmission2018 + "%");
console.log("Für Asien hat sich 2018 im Vergleich zu 2008 die Emission um " + (Asia2018 - Asia2008) * 100 / Asia2008 + " % verändert");
...
console.log("Relativ zur Gesamtemission der Welt verursacht Australien damit " + Australia2018 * 100 / totalEmission2018 + "%");
...
console.log("Relativ zur Gesamtemission der Welt verursacht Nordamerika damit " + NorthAmerica2018 * 100 / totalEmission2018 + "%");
...
console.log("Relativ zur Gesamtemission der Welt verursacht Südamerika damit " + SouthAmerica2018 * 100 / totalEmission2018 + "%");
...
console.log("Relativ zur Gesamtemission der Welt verursacht Afrika damit " + Africa2018 * 100 / totalEmission2018 + "%");
...
console.log("Relativ zur Gesamtemission der Welt verursacht Europa damit " + Europe2018 * 100 / totalEmission2018 + "%");
